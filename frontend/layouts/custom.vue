<template>
  <div class="bg-black w-screen h-screen text-white">
    <n-layout
      content-style="display: flex; flex-direction: column; width: 100vw; height: 100vh;"
    >
      ...
      <n-layout-content>
        ...
        <div class="w-full min-h-full flex flex-col py-2 px-8 child:flex-grow">
          <NuxtPage
            :key="key"
            :transition="{
              name: 'page',
    ...
    window.addEventListener("error", (event) => {
      if (messages.includes(event.message)) {
        ...
        notification.warning({
          title: "Soft Reload",
          description:
            "Ein Soft Reload wurde automatisch ausgeführt, um einen Bug zu beheben." +
